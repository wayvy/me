  ...
  return (
    <main className={classes.about}>
      ...
      <Article>
        ...
        <Paragraph>
          Могу сверстать любой дизайн на <em>flexbox</em>, адаптивно, кроссбраузерно, с переходами, анимациями и
          медиазапросами, чтоб было <em>pixel-perfect</em> и с <em>БЭМ</em>. Умею <em>SCSS</em> и <em>JSS</em>.
          Пользуюсь <em>Figma</em> / <em>Photoshop</em> / <em>Sketch</em>.
        </Paragraph>
        <Paragraph>
          Занимался созданием лендингов и интернет-магазинов на <em>OpenCart</em> на фрилансе. Умею хорошо верстать,
          находить общий язык с заказчиками, устанавливать дэдлайны и укладываться в них. Год назад понял, что
          распыляюсь по задачам в разных сферах и решил углубиться в мир <em>ES6+</em>.{' '}
